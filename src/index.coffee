  ...
  saveURI: ->
    ...
    $.ajax
      ...
      success: (res)=>
        ...
        $("#setting-project-twitter").html($("""
          <a href="https://twitter.com/share" class="twitter-share-button" data-size="large" data-text="'#{@model.get('title')}'" data-url="#{res.id}" data-hashtags="altjsdoit" data-count="none">Tweet</a>
        """))
        twttr.widgets.load()
  loadURI: ->
